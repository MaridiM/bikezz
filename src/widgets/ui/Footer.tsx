import { RiYoutubeFill, RiFacebookFill, RiTwitterFill, RiInstagramFill, RiPinterestFill, } from 'react-icons/ri'
                ...
                <div className="flex flex-col gap-8">
                    <div>
                        ...
                        <p className='text-white/60'>
                            Be the first to  get the latest news aboout trends, promotions, and much more!
                        </p>
                    </div>
                    ...
                    <form className='flex flex-col xl:flex-row w-full max-w-[720px] mx-auto gap-5'>
                        ...
                        <button className='btn btn-accent w-full xl:max-w-[150px] h-[60px]'>Join</button>
                    </form>
