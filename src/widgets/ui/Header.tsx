'use client'
import { CartSidebar, Nav } from "@/features"
            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-[26px]">
                    ...
                    <div onClick={() => handleCartClick()} className="relative cursor-pointer">
                        ...
                        <div className="bg-accent w-[18px] h-[18px] absolute -right-1 -bottom-1 rounded-full text-white flex items-center justify-center text-sm font-medium">{cartCount}</div>
                    </div>
                </div>
                <CartSidebar />
            </div>
